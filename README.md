...
1) Identifier les signaux (RPM, vitesse, position poignée de gaz, rapport engagé et frein)
2) Vérifier la forme des signaux (RPM = signal carré, poignée de gaz = signal analogique, etc.)
3) Eventuellement adapter le code au niveau de la programmation si le signal est complètement différent
